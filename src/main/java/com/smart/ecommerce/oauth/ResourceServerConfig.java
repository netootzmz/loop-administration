...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/catalogs/**").authenticated()
		.antMatchers("/manage-access/**").authenticated()
		.antMatchers("/label-system/**").permitAll()
		.antMatchers("/menu/**").authenticated()
		.antMatchers("/restorePassword/**").permitAll()
		.antMatchers("/role/**").authenticated()
		.antMatchers("/user/getByUserNameIncludingBlocked").permitAll()
		.antMatchers("/user/failedLoginAttempt").permitAll()
		//.antMatchers("/user/**").authenticated()
		.antMatchers("/clients/**").authenticated()
		.antMatchers("/ConfigurationScreenController/**").authenticated()
